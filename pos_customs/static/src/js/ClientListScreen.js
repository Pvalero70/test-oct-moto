odoo.define('pos_custom_settle_due.ClientListScreen', function (require) {
    'use strict';
    ...
    const POSSettleDueClientListScreenCustom = (ClientListScreen) =>
    ...
    Registries.Component.extend(ClientListScreen, POSSettleDueClientListScreenCustom);
