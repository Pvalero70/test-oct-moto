...
odoo.define('q_pdv_orders_repair.PaymentScreen', function (require) {
    'use strict';
    ...
    const OrderPaymentScreen = PaymentScreen => class extends PaymentScreen{
        constructor() {
            super(...arguments);
    ...
    Component.extend(PaymentScreen,OrderPaymentScreen)
